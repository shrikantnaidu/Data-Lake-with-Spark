...
def process_song_data(spark, input_data, output_data):
    ...
    """
    Processes the songs data and and extracts data for different tables.
    """
...
def process_log_data(spark, input_data, output_data):
    ...
    """  
    Processes the event log file and extracts data for different tables.
    """
...
def main():
    ...
    output_data = "s3a://sparkify-dend-bucket/"
